...
# --- Configuration ---
INPUT_DIR = r"/home/coder/project/Video_Transcript"   # Folder with raw .txt transcripts
OUTPUT_DIR = r"/home/coder/project/SummaryOutput2"  # Folder to save processed instruction data
